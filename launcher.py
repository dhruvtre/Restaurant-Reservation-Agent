"""
FoodieSpot Application Launcher

This module launches the FoodieSpot reservation system by starting both the 
...
def start_fastapi_server():
    ...
    try:
        ...
        subprocess.Popen(["uvicorn", "data.api_endpoints:app", "--host", "0.0.0.0", "--port", "8000"])
